...
shinyUI(fluidPage(theme = "bootstrap.css", 
                  navbarPage("2016 Presidential Debate: Content Breakdown",
                             tabPanel("About", p("
                                      ...
                                      p("picture retrieved from NYTimes.com")),
                             ...
                             tabPanel("Frequency",
                                      ...
                                      ##  Main Panel
                                      mainPanel(p("Enter a word that was said during the debates by either candidtate in the search box to view frequency of the word. Words are generated based on speaker and debate selected under Google Trends tab."),
