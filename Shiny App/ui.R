...
#Sidebar with options
  sidebarLayout(   
    sidebarPanel(
      #selectInput(inputDebate, "Debate", choices = c("First_Debate","Second_Debate", "Third_Debate"),
     selectInput(Speaker, label = "Speaker", choices = c("Hillary_Clinton","Donald_Trump"),
