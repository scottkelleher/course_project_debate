...
author: "Scott Kelleher, Janalee Thompson, Tulsi Gompo"
...
#this chuck is libraries and brining in data
```{r echo = False}
...
## specify inputs
  ...
  Debate = "Third_Debate"   # enter First_Debate or Second_Debate or Third_Debate
...
```{r echo=FALSE}
 ...
 DT::datatable(as.data.frame(top_used_words), options = list(pageLength = 25))
  ...
  if(Speaker=="Donald_Trump"){lines_go <- trump_lines
  words_gtrends <- words_t}
  if(Debate =="Hilary_Clinton"){lines_go <- clinton_lines
