...
break1 <- nrow(filter(trump_y, trump_y$debate == "1"))
break2 <- nrow(filter(trump_y, trump_y$debate == "2"))
break3 <- nrow(filter(trump_y, trump_y$debate == "3"))
clinton1 <- filter(df_c, df_c$debate == "1")
trump1 <- filter(df_t, df_t$debate = "1")
