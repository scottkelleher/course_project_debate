...
```{r}
 trump_emo_plot_this_shit <- rename(trump_emo, c(`colSums(prop.table(nrc_data_t[, 1:8]))` = "Fractional Amount of Total",
`rownames(trump_emo)` = "Sentiment"))
...
```{r echo = FALSE, warning = FALSE, message = FALSE}
 clinton_emo_plot_this_shit <- rename(clinton_emo, c(`colSums(prop.table(nrc_data_c[, 1:8]))` = "Fractional Amount of Total", `rownames(clinton_emo)` = "Sentiment"))
