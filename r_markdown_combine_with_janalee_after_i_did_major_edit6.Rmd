...
#all emotional context code adapted from Matthew Jockers syuzhet code ftp://cran.r-project.org/pub/R/web/packages/syuzhet/vignettes/syuzhet-vignette.html
for (i in (1:3)) {     
...
geom_bar(position="dodge", stat="identity") +
  ...
  scale_y_continuous(name = "Percent of Total", breaks = c(0, 0.05, 0.10, 0.15, 0.20, 0.25), labels = c("0", "5%", "10%", "15%", "20%", "25%")) +
  xlab("Sentiment") +
scale_fill_discrete(name = "Debate")+
theme(plot.title = element_text(hjust = .5))
...
ggplot(clinton_emo_plot_this_stuff, aes(y = emo_val, x = what_emotion, fill = factor(debate)))+
  ...
  #scale_y_continuous(name = "Percent of Total", breaks = c(0, 0.05, 0.10, 0.15, 0.20, 0.25, 0.30), labels = c("0", "5%", "10%", "15%", "20%", "25%", "30%")) +
  xlab("Sentiment") +
scale_fill_discrete(name = "Debate") +
theme(plot.title = element_text(hjust = .5)) 
```
